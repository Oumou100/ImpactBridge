...
import { AdminActivityImageField } from "./adminActivityImageField";
    ...
    >
      <div className="space-y-2">
        ...
        <input
          ...
          placeholder="Ex: Plantation communautaire a Casablanca"
        />
      ...
      <AdminActivityImageField
        coverImageUrl={form.coverImageUrl}
        coverImagePublicId={form.coverImagePublicId}
        disabled={isSubmitting}
        onChange={({ coverImageUrl, coverImagePublicId }) => {
          setForm((previous) => ({
            ...previous,
            coverImageUrl,
            coverImagePublicId,
